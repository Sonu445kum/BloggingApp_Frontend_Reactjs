...
// import { Link, useNavigate, useLocation } from "react-router-dom"; // ✅ useLocation added here
// import { motion, AnimatePresence } from "framer-motion";
// import {
//   Search,
//   Sun,
...
//     setMenuOpen(false);
//     setSuggestions([]);
//   }, [location.pathname]); // 🔥 dropdown/menu auto closes when user navigates anywhere
...
//   // ✅ Static links (hide "My Blogs" if not logged in)
//   const links = useMemo(() => {
//     const baseLinks = [
//       { name: "Home", path: "/" },
//       { name: "Blogs", path: "/blogs" },
...
//   // ✅ Redirect user to login if unauthenticated & tries to open restricted pages
